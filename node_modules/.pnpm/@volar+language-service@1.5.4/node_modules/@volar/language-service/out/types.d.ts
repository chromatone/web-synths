...
export type InjectionKey<T extends any[], R> = string & {
    __args?: T;
    __result?: R;
};
export declare function defineProvide<T extends InjectionKey<any, any>>(key: T, provider: T extends InjectionKey<infer A, infer R> ? (...args: A) => R | undefined : never): {
    [x: string]: T extends InjectionKey<infer A extends any[], infer R> ? (...args: A) => R | undefined : never;
};
