import { VirtualFiles, VirtualFile, FileRangeCapabilities, MirrorBehaviorCapabilities, MirrorMap, LanguageServiceHost } from '@volar/language-core';
...
export declare function createDocumentsAndSourceMaps(env: ServiceEnvironment, host: LanguageServiceHost, mapper: VirtualFiles): {
