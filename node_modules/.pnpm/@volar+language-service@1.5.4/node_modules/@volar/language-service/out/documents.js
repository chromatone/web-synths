...
function createDocumentsAndSourceMaps(env, host, mapper) {
    ...
    function getDocumentByFileName(snapshot, fileName) {
        ...
        if (!map.has(fileName)) {
            ...
            map.set(fileName, vscode_languageserver_textdocument_1.TextDocument.create(uri, host.getScriptLanguageId?.(fileName) ?? (0, common_1.resolveCommonLanguageId)(uri), version++, snapshot.getText(0, snapshot.getLength())));
        }
