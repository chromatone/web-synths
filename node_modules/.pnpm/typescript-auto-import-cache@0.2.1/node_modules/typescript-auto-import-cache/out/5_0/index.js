...
function default_1(ts, host, createLanguageService, rootDirectory) {
    const hostConfiguration = { preferences: { includePackageJsonAutoImports: 'auto' } };
    if (!projectService) {
        projectService = (0, projectService_1.createProjectService)(ts, ts.sys, rootDirectory, hostConfiguration, ts.LanguageServiceMode.Semantic);
    }
