...
transition(name="slide")
  .z-20.bottom-0.right-0.left-0.bg-light-800.bg-opacity-80.backdrop-blur.flex.flex-col.items-center.gap-4.justify-center.dark-bg-dark-200.dark-bg-opacity-80.p-4(
    :class="{'fixed':isFormOpen}"
    )
    .flex.flex-col.gap-4(v-if="isFormOpen")
