...
transition(name="slide")
  .fixed.z-200.min-h-50dvh.bottom-0.right-0.left-0.bg-light-800.bg-opacity-80.backdrop-blur.flex.flex-col.items-center.gap-4.justify-center.dark-bg-dark-200.dark-bg-opacity-80.p-8.shadow(v-show="isFormOpen")
    ...
    .flex.flex-col.gap-4.relative 
      ...
      label.text-center.max-w-45ch(for="email" v-html="texts['form-header']")
      ...
      .text-xs.opacity-60.text-center.max-w-45ch.mx-auto(v-html="texts.notice")
</template>
