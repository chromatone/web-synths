...
<template lang='pug'>
.flex.flex-wrap.gap-2.items-center.p-2.bg-light-900.bg-opacity-60.backdrop-blur-lg.dark-bg-dark-500.dark-bg-opacity-50.max-h-60.overflow-y-scroll.rounded.max-w-180.mx-auto.w-full
  .opacity-50
